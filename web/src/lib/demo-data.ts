...
export const demoNotes: SavedNoteRecord[] = [
  {
    ...
    folderName: '护肤口播感',
    filename: '帮我选选！两版面霜包装哪个好看',
    title: '帮我选选！两版面霜包装哪个好看',
    authorName: '桔点设计商店',
    sourceUrl: 'https://www.xiaohongshu.com/explore/69f321120000000000000001',
    coverImageUrl: makeDemoCover(['帮我选选！', '面霜包装'], '#d8f4ff', '#8fd8ee'),
    contentText:
      '帮我选选！两版面霜包装哪个好看？在各位股东热情的关怀中，面霜样品已经马上排产，只差最后一步，就是选瓶身的颜色。',
    savedAt: '2026-04-30T21:03:09.000Z',
  },
  {
    id: 'note-2',
    folderId: 'default-folder-lifestyle',
    folderName: '生活方式笔记',
    filename: '900人赞过的深圳市区骑行路线',
    title: '900人赞过的深圳市区骑行路线',
    authorName: '小木鱼 22',
...
export const demoSnippets: SavedSnippetRecord[] = [
  {
    ...
    noteTitle: '帮我选选！两版面霜包装哪个好看',
    noteAuthorName: '桔点设计商店',
    selectedText: '只差最后一步，就是选瓶身的颜色。',
    colorTagName: '开头钩子',
    colorValue: '#2A9D8F',
  ...
  },
  {
    ...
    noteTitle: '帮我选选！两版面霜包装哪个好看',
    noteAuthorName: '桔点设计商店',
    selectedText: '在各位股东热情的关怀中，面霜样品已经马上排产',
    colorTagName: '整体调性',
    colorValue: '#64748B',
