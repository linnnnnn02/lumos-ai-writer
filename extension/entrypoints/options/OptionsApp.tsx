...
function getContentHighlightStyle(visibleHighlight: ContentHighlight): CSSProperties {
  return {
    ...
    borderColor: visibleHighlight.colorValue || '#64748B',
  }
}
          ...
          <div className="note-tag-row">
            {visibleTags.map((snippet) => (
              <span key={snippet.id} className="note-tag">
                <span
                  className="tag-dot"
                  style={{ backgroundColor: snippet.colorValue || '#64748B' }}
                />
      ...
      <aside className="manager-sidebar" aria-label="笔记库文件夹">
        ...
        {isCreatingFolder ? (
          <div className="new-folder-panel">
            ...
            />
            <Button variant="soft" size="sm" type="button" onClick={() => void handleCreateFolder()}>
              创建
            </Button>
          </div>
        ) : null}
                      ...
                      {snippetDrafts.map((draft, index) => {
                        ...
                        return (
                          <article
                            ...
                            style={{ borderLeftColor: draft.colorValue || '#64748B' }}
                                  ...
                                  >
                                    <span className="snippet-tag-value">
                                      <span
                                        className="snippet-tag-dot-large"
                                        style={{
                                          backgroundColor: draft.colorValue || '#64748B',
                                        }}
                                      />
                                      <span
                                        className={
